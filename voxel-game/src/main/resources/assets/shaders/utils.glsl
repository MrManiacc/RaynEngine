 ...
 */
#define UNIFORMS-> viewMatrix(vert):mat4, modelMatrix(vert): mat4, projectionMatrix(vert): mat4, diffuse(frag): sampler2D
/**
...
//#define BINDS-> vertex(0, false): vec3, textureCoords(1, false): vec2, normal(2, false): vec3
